registerPlugin({
    name: 'Youtube Search - Edited By Mirarus',
    version: '1.3.4',
    engine: '>= 1.0.0',
    backends: ["ts3", "discord"],
    description: 'Youtube video search',
    author: 'NT5 - Edited By Mirarus',
    requiredModules: ["http"],
    vars: [
        {
            name: 'yt_apikey',
            title: 'API KEY (https://console.developers.google.com/project / AIzaSyAIf9_FMkLVIdPVRApu5ZvoO-XqXsitJrg)',
            type: 'string'
        },
        {
            name: 'ytdl_action',
    ...
    var youtube = {
        config: {
            api: {
                ...
                key: config.yt_apikey || "AIzaSyAIf9_FMkLVIdPVRApu5ZvoO-XqXsitJrg",
                maxresults: (function () {
                            ...
                            youtube.api.playlistItems({
                                ...
                                callback: function (pl) {
                                    ...
                                    pl.items.forEach(function (item) {
                                        ...
                                        Media.enqueueYtdl(item.contentDetails.videoId);
                                    });
                                }
                            });
                        }
